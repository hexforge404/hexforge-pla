"""
LEGACY Flask implementation for PLA Node.
This file is retained for reference only and is not used at runtime.
Current production server is FastAPI in app.fastapi_app:app.
"""
